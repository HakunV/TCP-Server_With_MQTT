...
public class GT06_Handler {
    ...
    public GT06_Handler(ProtocolHandler client) {
        this.client = client;
    }
    ...
    public void handleProtocol(String protocol, String dataString) {
        ...
        switch (protocol) {
            case "01":
                ...
                System.out.println();
                handleLogin(dataString, client.getIsn());
                break;
            case "22":
            ...
            case "13":
                ...
                System.out.println();
                handleStatus(dataString, client.getIsn());
                break;
            case "15":
            ...
            case "26":
                ...
                System.out.println();
                handleAlarm(dataString, client.getIsn());
                break;
            case "16":
                System.out.println("Alarm Message");
                System.out.println();
    ...
    private float checkLong(String longitude) {
        ...
        float longFloat = ((float) 180 / (float) 324000000)*longL;
    ...
    private float checkLat(String latitude) {
        ...
        float latFloat = ((float) 90 / (float) 162000000)*latL;
